describe EthereumTx::Utils, type: :model do
  describe "#int_to_base256" do
    ...
    let(:bin) { EthereumTx::Utils.hex_to_bin hex }
    let(:int) { EthereumTx::Utils.base256_to_int bin }

    it "gets the same result back" do
      base256 = EthereumTx::Utils.int_to_base256 int
